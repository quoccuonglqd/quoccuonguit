...
Trong mô hình mô phỏng, giả định rằng các hạt vật lý lấp đầy trong không gian và không bị chồng lấp. Trên 1 tiết diện có diện tích đáy là $$E$$, chiều cao $$\delta s$$, có $m(x)$ các hạt vật lý hình cầu có bán kính $$r$$ bằng nhau. Khi tia sáng chiếu tới vị trí tiết diện sẽ có 2 khả năng:
...
Tại 1 vị trí $$x_0$$, cường độ ánh sáng được bổ sung bởi nguồn sáng phản xạ tại đây    
...
Trong đó $$c(x_0)$$ là giá trị cường độ ánh sáng của các hạt tại vị trí $$x_0$$, $$\sigma(x_0)$$ là xác suất ánh sáng bắt nguồn từ các hạt ở vị trí này thay vì là ánh sáng từ background.

Đồng thời, nguồn sáng background $$I_0$$ bị hấp thụ bởi các hạt
...
Bởi vì không xét đến nguồn sáng của background, nên ta có giá trị $$I_0=0$$:  
![\Large](https://latex.codecogs.com/svg.latex?\Large&space;I(s)=\int_{0}^{s}c(x)\sigma(x)T(x)\,dx) (6)

Theo lý thuyết volume rendering, để tính giá trị màu từ cường độ ánh sáng, ta thay $$\sigma(x)$$ bằng $$1-exp(-\sigma(x))$$ 
...
Giả sử tia sáng đi qua vùng không gian cắt tại 1 đoạn thẳng $$AB$$. Ta chia $$AB$$ thành N đoạn bằng nhau; trên mỗi đoạn sample 1 điểm ở vị trí bất kỳ. Hàm tích phân ở vế phải phương trình (7) được ước lượng bởi:
